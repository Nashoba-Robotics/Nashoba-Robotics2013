...
CompressorStopCommand::CompressorStopCommand()  : Command("CompressorStartCommand"){
...
void CompressorStopCommand::Initialize() 
{
...
void CompressorStopCommand::End() {
	
}
// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void CompressorStopCommand::Interrupted() {
}
