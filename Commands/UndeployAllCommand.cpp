...
UndeployAllCommand::UndeployAllCommand() 
{
	AddParallel(new FixedUndeployCommand());
	AddSequential(new ArticulatedUndeployCommand());
	
	AddSequential(new TrackResetToZeroCommand());
	
	AddParallel(new FeetUndeployCommand());
	AddParallel(new TippingUndeployCommand());
