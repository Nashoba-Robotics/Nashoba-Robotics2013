...
{	
	...
	rBumperButtonX->WhenPressed(new TrackDriveSpeedCommand(SmartDashboard::GetNumber("Track Drive Speed")));
	
	lBumperButtonX = new JoystickButton(&xPad, XPad::kLeftBumperButton);
	lBumperButtonX->WhenPressed(new TrackDriveSpeedCommand(-SmartDashboard::GetNumber("Track Drive Speed")));
