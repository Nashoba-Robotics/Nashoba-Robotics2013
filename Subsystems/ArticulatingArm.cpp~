...
ArticulatingArm::ArticulatingArm() : Subsystem("ArticulatingArm") {
	...
	quadratureEncoder1 = RobotMap::articulatingArmQuadratureEncoder1;
	digitalInput1 = RobotMap::articulatingArmDigitalInput1;
	solenoid1 = RobotMap::articulatingArmSolenoid1;
