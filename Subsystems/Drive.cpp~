...
Drive::Drive() : Subsystem("Drive") {
	...
	encoder1 = RobotMap::driveEncoder1;
	quadratureEncoder2 = RobotMap::driveQuadratureEncoder2;
	quadratureEncoder3 = RobotMap::driveQuadratureEncoder3;
	quadratureEncoder4 = RobotMap::driveQuadratureEncoder4;
	digitalInput1 = RobotMap::driveDigitalInput1;
