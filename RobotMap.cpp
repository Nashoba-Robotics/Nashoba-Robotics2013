...
void RobotMap::init() 
{
	...
	lw->AddSensor(const_cast<char*>("Drive"), const_cast<char*>("Gyro 1"), driveGyro1);
	...
	lw->AddSensor(const_cast<char*>("Track"), const_cast<char*>("Quadrature Encoder 1"), trackQuadratureEncoder1);
	...
	lw->AddSensor(const_cast<char*>("Track"), const_cast<char*>("Analog Force 1"), trackAnalogForce1);
	
	trackAnalogForce2 = new AnalogChannel(1, 4);
	lw->AddSensor(const_cast<char*>("Track"), const_cast<char*>("Analog Force 2"), trackAnalogForce2);
	
	trackBrakeSolenoid = new Solenoid(1, 1);
	lw->AddActuator(const_cast<char*>("Track"), const_cast<char*>("Brake Solenoid"), trackBrakeSolenoid);
	
	trackSpeedController1 = new Victor(1, 1);
	lw->AddActuator(const_cast<char*>("Track"), const_cast<char*>("Speed Controller 1"), (Victor*) trackSpeedController1);
	
	trackSpeedController2 = new Victor(1, 2);
	lw->AddActuator(const_cast<char*>("Track"), const_cast<char*>("Speed Controller 2"), (Victor*) trackSpeedController2);
	
	tippingSolenoid1 = new Solenoid(1, 2);
	lw->AddActuator(const_cast<char*>("Tipping"), const_cast<char*>("Solenoid 1"), tippingSolenoid1);
	
	pneumaticsCompressorDigitalInput1 = new DigitalInput(1, 3);
	lw->AddSensor(const_cast<char*>("Pneumatics Compressor"), const_cast<char*>("Digital Input 1"), pneumaticsCompressorDigitalInput1);
